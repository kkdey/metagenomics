...
We use the relational topic model due to [Jonatha Huang](relational-topic) to explore
underlying micriobiome clusters in the HMP data, taking into consideration that samples collected from the same individual may share microbiome features unique to the individual. With the current framework, we hope to uncover micriobiome communities that share more similarities between individuals than within individuals.
